    ...
    <footer className='mt-6 md:mt-0 bg-[#02060C] text-white py-12 px-8 md:px-56'>
      <div className='container grid grid-cols-1 text-center  md:grid-cols-4 gap-4 mx-auto'>
        ...
        <div className='md:col-start-1 col-end-auto row-start-1 row-end-5'>
          ...
          <h4 className='text-gray-300 my-4'>© 2023 made By Nishant</h4>
          <h4 className='text-gray-300 my-4'>Live Order Tracking</h4>
          <h4 className='text-gray-300 my-4'>Lightning-Fast Delievery</h4>
          <h4 className='text-gray-300 my-4'>No Minimum Order</h4>
        </div>
